...
STATIC const mp_rom_map_elem_t board_global_dict_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_RGB_G), MP_ROM_PTR(&pin_GPIO9) },
    { MP_ROM_QSTR(MP_QSTR_RGB_B), MP_ROM_PTR(&pin_GPIO10) },
    ...
    { MP_ROM_QSTR(MP_QSTR_POWER), MP_ROM_PTR(&pin_GPIO12) },
      ...
      //Charge Control
    { MP_ROM_QSTR(MP_QSTR_CHARGE_LED_DISABLE), MP_ROM_PTR(&pin_GPIO13) },
    { MP_ROM_QSTR(MP_QSTR_CHARGE_STATUS), MP_ROM_PTR(&pin_GPIO14) },
